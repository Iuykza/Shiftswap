...
var PostReturnAddressController = {
     ...
     * @return {string}
     */
    createPostReturnAddress : function(addressName, addressLine1, addressLine2, addressCity, addressState, addressPostalCode, addressCountry, callback){

        //prepare query string for API call;
        var baseUri = configuration.BASEURI;
        
        var queryBuilder = baseUri + "/post/return-addresses";
    ...
    getPostReturnAddress : function(returnAddressId, callback){
        ...
        var queryBuilder = baseUri + "/post/return-addresses/{return_address_id}";
