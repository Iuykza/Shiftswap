...
fs.readFile('./node_modules/shiftswap/apikey.txt', function(err, data){
	if(err){
		if(err.errno === -4058)
			return console.error('Error: Create apikey.txt in node_modules/shiftswap.\n'+
				                 'Line 1: your api key.\n'+
...
stats = {
	...
	zip2: function(req, res){

	},
	exp: function(req, res){

	},
	expprev: function(req, res){

	},
	role: function(req, res){

	},
	trades: function(req, res){
...
schedule = {
	...
	role: function(req, res){
		...
		fs.readFile('./mock/employee/'+day+'.json', function(err, data){
			if(err)
				return console.error(err);
