...
var SmsCampaignController = {
     ...
     * @return {string}
     */
    createSmsCampaign : function(listId, name, from, body, schedule, callback){

        //prepare query string for API call;
        var baseUri = configuration.BASEURI;
        
        var queryBuilder = baseUri + "/sms-campaigns/send";
     ...
     * @return {string}
     */
    calculatePrice : function(listId, name, from, body, callback){

        //prepare query string for API call;
        var baseUri = configuration.BASEURI;
        
        var queryBuilder = baseUri + "/sms-campaigns/price";
     ...
     * @return {string}
     */
    updateSmsCampaign : function(smsCampaignId, listId, name, from, body, schedule, callback){

        //prepare query string for API call;
        var baseUri = configuration.BASEURI;
        
        var queryBuilder = baseUri + "/sms-campaigns/{sms_campaign_id}";
     ...
     * @return {string}
     */
    cancelSmsCampaign : function(smsCampaignId, callback){

        //prepare query string for API call;
        var baseUri = configuration.BASEURI;
        
        var queryBuilder = baseUri + "/sms-campaigns/{sms_campaign_id}/cancel";
     ...
     * @return {string}
     */
    getSmsCampaigns : function(callback){

        //prepare query string for API call;
        var baseUri = configuration.BASEURI;
        
        var queryBuilder = baseUri + "/sms-campaigns";
     ...
     * @return {string}
     */
    getSmsCampaign : function(smsCampaignId, callback){

        //prepare query string for API call;
        var baseUri = configuration.BASEURI;
        
        var queryBuilder = baseUri + "/sms-campaign/{sms_campaign_id}";
