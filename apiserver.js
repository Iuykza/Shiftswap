...
.get('/stats/age/:age'  , stats.age)
.get('/stats/sex/:sex'  , stats.sex)
.get('/stats/race/:race', stats.race)
.get('/stats/zip/:zip'  , stats.zip)
.get('/stats/zip'       , stats.zip2)
.get('/stats/exp'       , stats.exp)
.get('/stats/expprev'   , stats.expprev)
.get('/stats/role'      , stats.role)
.get('/stats/trades'    , stats.trades)
